                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="hidden" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ $username }}" required>
                        ...
                        <div class="form-group row">
                            <label for="BSU_id" class="col-md-4 col-form-label text-md-right">{{ __('BSU ID #') }}</label>

                            <div class="col-md-6">
                                <input id="BSU_id" type="text" class="form-control" name="BSU_id" required autocomplete="BSU ID">
                            </div>
                        </div>
